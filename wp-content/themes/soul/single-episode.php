...
<?php $recent = new WP_Query("page_id=19");
...
<?php endwhile; wp_reset_query(); ?>
		...
		?>
			...
			<div class="show_dwnload">
                    ...
                    <div class="rgt_part">
                        ...
                        <div class="show_information">
                            <label>Category:</label> <?php the_field('category',$post->ID); ?>
                        </div>
                        <div class="show_information">
                            <label>Length:</label> <?php the_field('length',$post->ID); ?>
                        </div>
                        <div class="show_information">
	...
	<?php
	  ...
	  <input class="id" type="hidden" name="id" value="<?php echo $current_user->ID;  ?>" >
        ...
        <a class="dwnld_wtch_btn" href="<?php echo site_url(); ?>">Login and Download the episode</a>
         <?php } ?> 
                    </div>
                </div>
		...
		?>
                ...
                <div class="other_tv_show">
                    <h2>OTHER TOP Episode</h2>
                    <ul>
                    
    <?php 
				global $post;
				query_posts('post_type=episode&showposts=4&order=desc&meta_key =_is_ns_featured_post&meta_value= yes'); 
				while (have_posts()) : the_post();
				?>
             <li>
		   ...
		   <?php 
 $args = array('post_type' => 'episode','posts_per_page'=>-1,'order' => 'DESC','post_status'=> 'publish');

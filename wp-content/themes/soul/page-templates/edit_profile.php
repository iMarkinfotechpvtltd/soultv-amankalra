...
get_header(); // Loads the header.php template. ?>
	...
	<?php do_action( 'before_content' ); // florence_before_content ?>

	<section id="content">

		<?php do_action( 'open_content' ); // florence_open_content ?>
...
<?php endif; ?>
		...
		<?php do_action( 'close_content' ); // florence_close_content ?>

	</section><!-- #content -->

	<?php do_action( 'after_content' ); // florence_after_content ?>
